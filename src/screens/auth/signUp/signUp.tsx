...
type SignUpScreenNavigationType =
  NativeStackNavigationProp<
    AuthStackProps,
    'SignUp'
  >;
...
const SignUp: FC = () => {
  const navigation =
    useNavigation<SignUpScreenNavigationType>();
  ...
  const [confirmedRegion, setConfirmedRegion] =
    useState<Region | null>(null);
  ...
  const [base64Files, setBase64Files] =
    useState<any[]>([]);
          ...
          <View
            ...
            <View
              ...
              <View
                ...
                <View
                  style={
                    mapStyles.previewCard
                  }>

                  <View
                    style={
                      mapStyles.textContainer
                    }>
